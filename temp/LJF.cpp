...
void ljf(vector<Process> &processes)
{
    ...
    cout << "+-----+--------------+------------+-----------------+-------------------+" << endl;
    cout << "| PID | Arrival Time | Burst Time | Waiting Time (s) | Turnaround Time (s) |" << endl;
    cout << "+-----+--------------+------------+-----------------+-------------------+" << endl;
    ...
    for (int i = 0; i < n; i++)
    {
        ...
        cout << "| " << setw(3) << p.id << " | " << setw(12) << p.arrival_time << " | " << setw(10) << p.burst_time << " | " << setw(15) << waiting_time << " | " << setw(17) << turnaround_time << " |" << endl;
    }
